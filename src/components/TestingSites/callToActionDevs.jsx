  ...
  <div className="container-fluid ts-section">
    <div className="row">
      <div className="col-sm-12 ts-call-to-action">
        ...
        <Link to="https://github.com/postmanlabs/covid-19-apis" className="btn btn-dark ts-button">
...
export default CallToActionDevs;
