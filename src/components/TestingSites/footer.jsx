    ...
    <div className="container">
      <div className="row">
        <div className="col-sm-12 mb-4">
          <a className="homelink" href="/covid-19-testing-location/">COVID-19 Testing Sites</a>
          ...
          <a className="navlink" href="/covid-19-testing-location/legal/">Legal</a>
