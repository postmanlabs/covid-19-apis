        ...
        <div className="container">
          <div className="row mb-4">
            <div className="col-md-10 offset-md-1">
              <p>This is an effort to crowdsource and centralize the availability of <a href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019" target="_blank">COVID-19</a> testing locations across all 50 US states using two freely available online tools while using APIs to make sure the location data can be syndicated and distributed as widely as possible. The two tools are:</p>
            </div>
