          ...
          <div className="row mb-4">
            ...
            <div className="col-sm-12">
                <dl className="ts-definition-list">
                    ...
                    <dd>Google Sheets provides a free, easy-to-use, broadly accessible medium for managing the centralized testing-location data. Learn more in <a href="/covid-19-testing-sites/how-it-works/">How it Works</a>.</dd>
                    <dt>Why does the project use Postman?</dt>
                    <dd><a href="https://www.postman.com/">Postman</a> provides a free, easy-to-use, broadly accessible medium for publishing and consuming APIs, making the testing-location data more accessible to developers.</dd>
                    <dt>Why are there separate tabs for organizations, locations, physical addresses, phones, and regular schedules?</dt>
                    <dd>We've created separate tabs for each of these items because we are using the <a href="https://openreferral.org" target="_blank">Open Referral standard</a>. This approach makes the data available in a spreadsheet format while also providing a single complete endpoint that stitches it all together.</dd>
                </dl>
            </div>
          </div>
        </div>
